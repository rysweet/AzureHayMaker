...
add_code(
    prs,
    "Critical Discovery: Mail.Send Required",
    """# Permission needed for sending email:
...
add_code(
    prs,
    "Monitor - haymaker kw list-workers",
...
add_code(
    prs,
    "Monitor - haymaker kw list-resources",
