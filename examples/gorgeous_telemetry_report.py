...
async def demo_gorgeous_report():
    ...
    tree.add("📅 Calendar Events").add(f"[blue]{data['total_calendar_events']:,} events created[/blue]")
    tree.add("💬 Teams Activity").add(f"[magenta]{data['total_teams_messages']:,} messages posted[/magenta]")
