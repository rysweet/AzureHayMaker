"""E2E test fixtures for engineering simulation.

Provides shared fixtures for end-to-end tests including mock GitHub clients
...
def mock_github_client():
    """Fixture providing a mock GitHub API client for E2E tests.
