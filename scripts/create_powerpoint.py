...
add_code_slide(
    prs,
    "Deployment Configuration (REAL)",
    """# From evidence/01_deployment_config.json
...
add_content_slide(
    prs,
    "Security Hardening (28 Tests Passing)",
    [
...
add_content_slide(
    prs,
    "Resources Ready for Full Deployment",
    [
