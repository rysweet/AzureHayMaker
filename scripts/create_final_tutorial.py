...
add_code(
    prs,
    "haymaker kw list-workers (5-Worker REAL Output)",
    """Total: 5 workers
...
add_code(
    prs,
    "haymaker kw list-resources (5-Worker REAL Output)",
    """Entra Users: 5
Security Groups: 1
...
add_code(
    prs,
    "Deploy 25 Workers - REAL Command",
    """# Create config file
...
add_bullets(
    prs,
    "25-Worker Deployment Results (REAL)",
    [
