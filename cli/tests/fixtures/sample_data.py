...
def sample_execution_data(count: int = 5, offset_minutes: int = 0) -> List[Dict[str, Any]]:
    ...
    for i in range(count):
        ...
        executions.append({
            ...
            "completed_at": (execution_time + timedelta(minutes=5)).isoformat() if i % 3 != 2 else None,
...
def sample_agent_data(execution_id: str, count: int = 10) -> List[Dict[str, Any]]:
    ...
    for i in range(count):
        ...
        agents.append({
            ...
            "completed_at": (agent_time + timedelta(seconds=120)).isoformat() if i % 3 != 2 else None,
