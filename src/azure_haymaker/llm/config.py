...
This module defines the LLMConfig model for configuring LLM providers.

Philosophy:
- Single responsibility: Configuration model only
- Validation at config time, not runtime
